...
Primero, creé [una tabla (luego CSV) con las columnas año, película, reparto y personaje](../assets/datasets/almodovar_pelis_cast.csv) (esta variable no la he utilizado), lo que me permitió, a su vez, crear un listado de características de [cada persona con su género](../assets/datasets/almodovar_reparto.csv). 
...
Este [listado](../assets/datasets/almodovar_aristas.csv) indica la co-aparición de dos actores o actrices en una misma película, sin tener en cuenta si son protagonistas, secundarios, terciarios, la cantidad de palabras que dicen en la película, el tiempo que pasan en pantalla, etc. 
